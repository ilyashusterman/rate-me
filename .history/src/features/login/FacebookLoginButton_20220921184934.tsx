...
const USER_SPREAD_SHEET_ID = "1dFQLt9EDkvf82gQ9DjAo6A-6MbKB2qkFm5M6wUE0_l4";
const USER_SPREAD_SHEET_GID = "204851983";
...
const FacebookLoginButton = () => {
  ...
  const userDatabase = new UserDatabase(
    USER_SPREAD_SHEET_ID,
    USER_SPREAD_SHEET_GID
  );
  ...
  useEffect(() => {
    fetchSpreadSheetJson(USER_SPREAD_SHEET_ID, USER_SPREAD_SHEET_GID).then(
      (users) => {
        setUsers(users);
      }
    );
